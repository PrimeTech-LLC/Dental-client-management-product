              ...
              <div className="flex items-center justify-between">
                ...
                {onOpenNewPatientInline && (
                  <button type="button" onClick={onOpenNewPatientInline}
                    className="text-blue-800 hover:text-blue-800 font-semibold text-[11px] flex items-center gap-1">
              ...
              {selectedPatient ? (
                <div className="p-3 rounded-lg bg-blue-50/80 border border-blue-200 flex items-center justify-between">
                  <div>
                    <div className="font-semibold text-slate-900 flex items-center gap-2 flex-wrap">
                      ...
                      <span className="font-mono text-[10px] text-blue-800 bg-blue-50 px-1.5 py-0.5 rounded">
                ...
                <div className="space-y-2">
                  <input type="text" placeholder="Search by name, phone, or PT-000001…"
                    ...
                    className="w-full px-3 py-2 bg-slate-50 border border-slate-300 rounded-lg text-xs focus:bg-white focus:outline-none focus:ring-1 focus:ring-blue-800" />
                  {patients.length > 0 && (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                ...
                <select value={startTime} onChange={e => setStartTime(e.target.value)}
                  className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-xs font-mono focus:ring-1 focus:ring-blue-800 focus:outline-none">
